  ...
  render(): JSX.Element {
    ...
    return (
      <article className="properties-box">
        <div className={this.state.propertiesBoxCheckboxClass} onClick={this.onCheckboxChange.bind(this)}>
          <div className="properties-box__checker"></div>
        </div>
        <div className="properties-box__box">
          <span className="properties-box__span" onClick={this.onCheckboxChange.bind(this)}>{this.translate([this.props.label])[this.props.label]}</span>
          <div className={this.state.propertiesBoxPropertiesClass}>{propertyList}</div>
        </div>
      </article>
    );
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(PropertiesBox);
